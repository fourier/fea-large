function export_condder(fname,elements,nodes0,nodes,boundary,IDX,msize)
...
X = create_u_from_nodes(msize,nodes0,nodes,elements,IDX);

for i=1:elements_count
	el = element_full(nodes0,elements,i);
	v = zeros(12,1);
