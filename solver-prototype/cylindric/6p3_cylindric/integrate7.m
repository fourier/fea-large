...
if linear == 1 % don't use q
	M = w1*F(el,a(1),a(2))*a(1)+...
			w2*F(el,b(1),b(2))*b(1)+w2*F(el,c(1),c(2))*c(1)+...
			w2*F(el,d(1),d(2))*d(1)+...
			w3*F(el,e(1),e(2))*e(1)+w3*F(el,f(1),f(2))*f(1)+w3*F(el,g(1),g(2))*g(1);
else % use q 
	M = w1*F(el,q,a(1),a(2))*a(1)+...
			w2*F(el,q,b(1),b(2))*b(1)+w2*F(el,q,c(1),c(2))*c(1)+...
			w2*F(el,q,d(1),d(2))*d(1)+...
			w3*F(el,q,e(1),e(2))*e(1)+w3*F(el,q,f(1),f(2))*f(1)+...
			w3*F(el,q,g(1),g(2))*g(1);
end
